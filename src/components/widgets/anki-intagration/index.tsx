...
export default function AnkiIntagration() {
    return (
        <Flex vertical gap="middle">
            <Flex vertical>
                <Text>1. Install Anki from <Link href="https://apps.ankiweb.net/" target="_blank">here</Link> (official site)</Text>
                <Text>2. Open anki and Go to Tools then Addons then Get Add-ons</Text>
                <Text>3. Copy paste the addon id: <Text copyable ={{ text: '2055492159' }} code> 2055492159 </Text></Text>
                ...
                <Button color="primary" variant="solid" style={{width:"100px"}}>Check</Button>
        </Flex>
    )
}
